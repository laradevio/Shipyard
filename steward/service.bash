...
DESC="Laravel Queue Worker Daemon"
PIDFILE="/var/run/${NAME}.pid"
LOGFILE="/proc/self/fd/1"

# Edit this line to change your Queue options (like connection)
DAEMON="/usr/bin/php /var/www/artisan queue:work --sleep=3 --tries=3"
DAEMON_OPTS="> /proc/self/fd/1 2>&1"

START_OPTS="--start --foreground --make-pidfile --pidfile ${PIDFILE} --exec ${DAEMON} ${DAEMON_OPTS}"
